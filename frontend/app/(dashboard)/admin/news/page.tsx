              ...
              <tbody className="divide-y">
                {news?.map((newEl) => (
                  ...
                  >
                    ...
                    <td
                      className="p-4 font-medium text-gray-900 max-w-50 truncate"
                      title={newEl.title}
                    >
                      {newEl.title}
                    </td>
                    ...
                    >
                      <Button
                        ...
                        className={`w-38.75  ${newEl.isPublished ? "text-orange-600 hover:bg-orange-50" : "text-blue-600 hover:bg-blue-50"}`}
                      >
