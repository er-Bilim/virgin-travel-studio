...
import { ExternalLink, Loader2, Mail, MapPin, Phone, Globe, X, Image as ImageIcon } from 'lucide-react';
import {
  FaInstagram,
  FaTelegramPlane,
  FaWhatsapp,
...
export default function Contacts () {
  ...
  const logoSrc = contactSettings?.logo ? imageUrl + contactSettings.logo : null;
                  ...
                  <div>
                    ...
                    {logoSrc ? (
                        <img
                            ...
                            className="mt-1 h-8 w-auto rounded border bg-background p-1 object-contain"
                        />
                    ) : (
                        <p className="text-sm font-medium text-muted-foreground">Не указан</p>
                    )}
                  </div>
                </div>
