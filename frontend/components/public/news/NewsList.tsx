...
const NewsList = () => {
  ...
  const mainNewsDate = mainNews
      ? formatDayAndMonthWords(mainNews.createdAt)
      : null;
  ...
  return (
      <div className="w-full pb-16">
        ...
        <div className="mb-6 border-b border-gray-100 dark:border-slate-800 pb-6">
          <div className="mb-6 grid grid-cols-1 gap-3 md:grid-cols-[1fr_1fr_auto_auto]">
            <label className="flex flex-col gap-1 text-sm text-slate-500">
              ...
              <input
                  ...
                  className="rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-700 outline-none focus:border-[#1E2B6D]"
              />
            </label>
            ...
            <button
                ...
                className="self-end rounded-xl bg-[#1E2B6D] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#172258]"
            >
              Применить
            </button>
            ...
            {(startDate || endDate || draftStartDate || draftEndDate) && (
                <button
                    ...
                    className="self-end rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50"
                >
                  Сбросить
                </button>
            )}
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">
                  Попробуйте изменить даты или выбрать другую тему
                </p>
              </div>
            </div>
        ) : (
            ...
            <div className="flex flex-col justify-center py-1">
              ...
              <span className="font-semibold text-slate-700 dark:text-slate-300 md:text-slate-800 md:dark:text-slate-200 md:leading-none md:block">
                {news.allNews[0].author.fullName}
                  ...
                  >
                    {mainNewsDate?.day} {mainNewsDate?.month}
                  </time>
                </div>
              </div>
            </div>
