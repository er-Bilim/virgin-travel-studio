...
import { imageUrl, isDev, itemsNavHeader } from '@/lib/constants';
      ...
      >
        <div>
          <div className="mx-auto flex flex-col sm:flex-row sm:h-20 max-w-[1400px] items-center px-4 sm:px-[20px] justify-between gap-3 sm:gap-4 py-3 sm:py-0">
            <div className="relative flex w-full sm:w-auto justify-center sm:justify-start items-center">
              <Link
                href="/"
              ...
              >
                <Image
                  ...
                  priority
                  unoptimized={isDev}
                  className="h-6 w-auto shrink-0 object-contain brightness-110"
                />
            ...
            <div className="flex w-full sm:w-auto items-center justify-between sm:justify-end gap-2 border-t border-white/10 pt-2 sm:border-0 sm:pt-0 shrink-0">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  aria-label={
                    isMenuOpen ? 'Закрыть главное меню' : 'Открыть главное меню'
                  }
                >
